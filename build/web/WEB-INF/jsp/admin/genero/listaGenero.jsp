...
<html>
    ...
    <link rel="stylesheet" href="assets/css/smoothproducts.css">
        <title>Lista Género Película</title>
    </head>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="editarGenero.htm?id=${dato.GEN_ID}" class="btn btn-primary ">Edit</a>
                                    <a href="eliminarGenero.htm?id=${dato.GEN_ID}" class="btn btn-primary ">Delete</a>
