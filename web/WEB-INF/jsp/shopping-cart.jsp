...
<head>
    ...
    <title>Shopping Cart - Neflix</title>
        ...
        <div class="container"><img src="assets/img/stickeroid_5bf5461d4e179-5.png"><a class="navbar-brand logo" href="#"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="catalog-page.html">CATALOGO</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="product-page.html">VER PELICULA</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="login.html">Iniciar sesión</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="registration.html">Registrarse</a></li>
                </ul>
        </div>
        </div>
    </nav>
